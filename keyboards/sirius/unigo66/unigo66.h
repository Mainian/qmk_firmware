...
#define LAYOUT_all( \
  ...
  KE0,KE3,KE2,                                    K50,K51,K4F,    \
    ...
    { K30,   K31,   /*K32*/KC_NO, K33,   K34,   /*K35*/KC_NO,   K36,   K37,      /* 30-37 */ \
      /*K38*/KC_NO,   K39,   /*K3A*/KC_NO,   /*K3B*/KC_NO,   /*K3C*/KC_NO,   /*K3D*/KC_NO,   /*K3E*/KC_NO,   /*K3F*/KC_NO    }, /* 38-3F */ \
 ...
 */
 ...
 #define LAYOUT_UniGo66( \
  ...
  K29,  K1E,  K1F,  K20,  K21,  K22,  K2D,       K2E,  K23,  K24,  K25,  K26,  K27,  K2A,    \
  K2B,  K14,  K1A,  K08,  K15,  K17,  K4B,       K2F,  K1C,  K18,  K0C,  K12,  K13,  K31,    \
  K39,  K04,  K16,  K07,  K09,  K0A,  KC_NO,     KC_NO,K0B,  K0D,  K0E,  K0F,  K33,  K34,    \
  KE1,  K1D,  K1B,  K06,  K19,  K05,  K4E,       K30,  K11,  K10,  K36,  K37,  K52,  KE5,    \
  KE0,  KE3,  KE2,  KC_NO,KC_NO,KC_NO,KC_NO,     KC_NO,KC_NO,KC_NO,KC_NO,K50,  K51,  K4F,    \
  KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,K2C,  K49,       K4A,  K28,  KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,  \
  KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KE6,  K4C,       K4D,  KE4,  KC_NO,KC_NO,KC_NO,KC_NO,KC_NO   \
 }
